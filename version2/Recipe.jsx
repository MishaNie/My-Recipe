...
//saving the object into an array
function Recipe(props) {
    ...
    const handleSave = () => {
        setSavedRecipes(prevRecipes => [...prevRecipes, details]);
    };
...
// Fetching data for individual objects
    const fetchDetails = async () => {
        const data = await fetch(
            `https://api.spoonacular.com/recipes/${params.name}/information?apiKey=99ee303e0c63493fba9f26521ba72c47`
        );
    ...
    return (
        <DetailWrapper>
            ...
            <Info>
                ...
                <Button className={activeTab === 'Save' ? 'active' : ''} onClick={handleSave}>
                    Save
                </Button>
